  ...
  return (
      ...
      style={
        {
          ...
          // CSS var consumida pelos paths (.hull-fill etc). Permite que
          // o CSS controle stroke por estado da camada.
          ['--c-done' as string]: fallbackColor,
    ...
    >
      <style>{`
        ...
        /* Done = paths impressos, sólidos na cor do filamento */
